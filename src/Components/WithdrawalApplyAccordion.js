...
import WithdrawalApplyAccordionItem from './WithdrawalApplyAccordionItem';

const WithdrawalApplyAccordion = ({ onSendIdData ,messages}) => {
...
export default WithdrawalApplyAccordion;
