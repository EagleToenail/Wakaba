...
export default function Navbar({ sendURL }) {
  ...
  return (
    <>
      <header className='flex shadow-md  sm:px-3 bg-[#524c3b] font-[sans-serif] h-[40px] tracking-wide relative z-50 justify-end'>
        <div className='flex flex-wrap items-center justify-between gap-5 '>
          ...
          <div className='flex max-lg:ml-auto space-x-3'>
            ...
            {/* <button id="toggleOpen" style={{display:'hidden'}} onClick={handleClick}> */}
