...
import DisposalPermissionAccordionItem from './DisposalPermissionAccordionItem';

const DisposalPermissionAccordion = ({ onSendIdData ,messages}) => {
  ...
  const renderMessages = (messages) => {
    return messages.map(message => (
      <DisposalPermissionAccordionItem
        key={message.id}
        time={message.time}
...
export default DisposalPermissionAccordion;
