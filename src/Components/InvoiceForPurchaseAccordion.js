...
import InvoiceForPurchaseAccordionItem from './InvoiceForPurchaseAccordionItem';

const InvoiceForPurchaseAccordion = ({ onSendIdData ,messages}) => {
  ...
  const renderMessages = (messages) => {
    return messages.map(message => (
      <InvoiceForPurchaseAccordionItem
        key={message.id}
        time={message.time}
...
export default InvoiceForPurchaseAccordion;
