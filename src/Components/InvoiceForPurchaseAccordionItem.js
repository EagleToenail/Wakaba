      ...
      {isOpen && (
        <div style={styles.content}>
          ...
          {fileUrl && isImageFile(fileUrl) ? (<div className='w-full h-[150px] flex justify-center' >
            <img src={`${wakabaBaseUrl}/uploads/invoiceforpurchase/${fileUrl}`} alt="Uploaded" style={styles.imagePreview} />
            <a href={`${wakabaBaseUrl}/uploads/invoiceforpurchase/${fileUrl}`} target="_blank">
                Open in Brosewer 
            </a>
          </div>
          ) : (<div className='w-full h-10 flex justify-center'>
            <a href={`${wakabaBaseUrl}/uploads/invoiceforpurchase/${fileUrl}`} download={fileUrl} target="_blank" rel="noopener noreferrer">
              Download {fileUrl}
            </a>
          </div>
          )}
