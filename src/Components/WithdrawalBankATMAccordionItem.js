...
const permitFunction = () => {
  ...
  axios.post(`${wakabaBaseUrl}/withdrawbankatmmessage/permitok`,{messageId:messageId})
    .then(response => {  
...
const completeFunction = () => {
  ...
  axios.post(`${wakabaBaseUrl}/withdrawbankatmmessage/completeok`,{messageId:messageId,parentMessageId:parentMessageId})
    .then(response => {
