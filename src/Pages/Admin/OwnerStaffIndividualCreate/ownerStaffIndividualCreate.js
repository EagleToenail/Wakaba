...
const OwnerStaffIndividualCreate = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (idcardFile) formDataObj.append('idcard_image', idcardFile);
            console.log("sfsdfasdfa",formDataObj);
                            ...
                            <form className=" space-y-6" onSubmit={handleSubmit}>
                                ...
                                <div className='flex'>
                                    ...
                                    <div style={{ width: '30%', flexDirection: 'column', }} className='flex align-center justify-around'>
                                        <select id="prefeature" value={profileData.prefeature||''} onChange={handleChange} name="prefeature"  className="w-full h-full text-[#70685a] font-bold border border-[#70685a] px-4 py-1 outline-[#70685a]">
                                            <option value="" disabled></option>
                                ...
                                <div className='flex justify-between !mt-5 pb-10' >
                                    ...
                                    <label className="text-[#70685a] font-bold mb-2 block text-left flex justify-end" style={{ flexDirection: 'column', width: '20%' }}><u> <Link to='/admin/ownersstafflist'>キャンセル</Link></u></label>
                                </div>
                            </form>
                        </div>
                    </div>
...
export default OwnerStaffIndividualCreate;