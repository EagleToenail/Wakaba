...
const OwnerAnalysisAreaAnalysis = () => {
    ...
    return (
        <>
            ...
            <div className='flex justify-around mt-5' >
                ...
                <h2 className="text-[#70685a] text-center text-2xl font-bold flex justify-center">オーナー管理画面&nbsp;&nbsp;    エリア分析</h2>
...
export default OwnerAnalysisAreaAnalysis;