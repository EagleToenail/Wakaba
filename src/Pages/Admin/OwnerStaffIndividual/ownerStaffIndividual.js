...
const OwnerStaffIndividual = () => {
    ...
    useEffect(() => {
        ...
        const fetchProfileData = async () => {
            try {
                const response = await axios.post(`${wakabaBaseUrl}/admin/profile/getindividualprofile`, { userId });
        ...
        fetchProfileData();
    }, [userId]); // Add userId to dependencies if it can change
    ...
    const handleSubmit = async (e) => {
        ...
        formDataObj.append('type', profileData.type);
        ...
        try {
            ...
            const response = await axios.post(`${wakabaBaseUrl}/admin/user/updateuserprofile`, formDataObj, {
                headers: {
            ...
            navigate('/admin/ownersstafflist'); // Navigate to the profile page after closing the modal
        } catch (error) {
                    ...
                    <div className="w-full" style={{ maxWidth: '80em' }}>
                        <div className=" rounded-2xl">
                            ...
                            <div className='w-full flex justify-end'>
                                <label className="w-max text-[#70685a] font-bold block text-right" style={{ flexDirection: 'column'}}><u> <Link to='/admin/ownersstafflist'>キャンセル</Link></u></label>
                            </div>
                            <div className='w-full flex justify-around mt-2'>
                                <div className='w-1/3 flex justify-center'>
                                        <button name='delete' type="button" className="w-max px-10 py-1 font-bold text-[white] tracking-wide text-2xl rounded-lg justify-center t bg-[#838383] hover:bg-blue-700 focus:outline-none">
                                        削除
                                        </button>
                                </div>
                                <div className='w-1/3 flex justify-center'>
                                    <button name='keep' onClick={handleSubmit} type="button" className="w-max px-20 py-1 font-bold text-[white] tracking-wide text-2xl rounded-lg justify-center t bg-[#e87a00] hover:bg-blue-700 focus:outline-none">
                                        保存
                                    </button>
                                </div>
                                <div className='w-1/3 flex justify-center'>
                                    <button name='new' onClick={gotoCreate} type="button" className="w-max px-10 py-1 font-bold text-[#665b4b] tracking-wide text-2xl rounded-lg justify-center t bg-[#ebe6e0] hover:bg-blue-700 focus:outline-none">
                                        新規スタッフ登銀
                                    </button>
                                </div>
                            </div>
                            ...
                            <form className="mt-5 space-y-6" >
                                ...
                                <div className='flex'>
                                    ...
                                    <div style={{ width: '25%', flexDirection: 'column', }} className='flex align-center justify-around'>
                                        <select id="type" name="type" onChange={handleChange} value={profileData.type||''} required className="w-full text-[#70685a] font-bold border border-[#70685a] px-4 py-2 outline-[#70685a]">
