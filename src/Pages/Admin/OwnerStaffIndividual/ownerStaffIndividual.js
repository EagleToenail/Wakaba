...
const OwnerStaffIndividual = () => {
    ...
    useEffect(() => {
        ...
        axios.post(`${wakabaBaseUrl}/admin/profile/getindividualprofile`,{userId})
            .then(response => {
                        ...
                        <div className="w-full" style={{ maxWidth: '80em' }}>
                            <div className=" rounded-2xl">
                                ...
                                <div className='w-full flex justify-around mt-5'>
                                    ...
                                    <label className="w-max text-[#70685a] font-bold mb-2 block text-right" style={{ flexDirection: 'column'}}><u> <Link to='/admin/ownersstafflist'>キャンセル</Link></u></label>
                                </div>
