...
const ManagementVariousMasterProductCategory2 = () => {
                ...
                <div className="w-full " style={{ maxWidth: '90em' }}>
                    ...
                    <div className='flex mt-5 justify-center text-left'>
                        <div className=' text-[#70685a] px-2 mr-5 text-2xl font-bold flex flex-col justify-end'>
                            <label className="text-[#70685a] mb-2 block text-center pb-13">商品力テゴリ一2</label>
                        </div>
                    </div>
...
export default ManagementVariousMasterProductCategory2;