                        ...
                        <div className=" rounded-2xl">
                            ...
                            <form className=" space-y-6" onSubmit={handleSubmit}>
                                ...
                                <div className='flex'>
                                    ...
                                    <div style={{ width: '50%', flexDirection: 'column', }} className='flex align-center justify-around'>
                                        <select id="customer_id" name="customer_id" onChange={handleChange} value={salesSlipData.customer_id} className="w-full text-[#70685a] font-bold border border-[#70685a] px-4 py-2 outline-[#70685a]">
