...
export default function InvoiceForPurchaseChat() {
    ...
    useEffect(() => {
      const fetchMessages = async () => {
        ...
        const userId = localStorage.getItem('userId');
        axios.get(`${wakabaBaseUrl}/invoicepurchasemessages/${userId}`)
          .then(response => {
    ...
    const sendInvoiceForPurchaseMessage = async () => {
        ...
        if (reply.title != '' && reply.content != '' && reply.senderId != '' && reply.receiverId != '') {
            ...
            try {
                ...
                await axios.post(`${wakabaBaseUrl}/invoicepurchasemessages/getmessagelist`, formData, {
                    headers: {
                        ...
                        <div style={{ width: '90%', height: '50px' }} className='text-center'>
                            ...
                            <div className='flex mt-2' style={{ height: '55px' }}>
                                ...
                                <div className='ml-10 flex flex-col justify-center'>
                                    < button type="button" onClick={() => sendInvoiceForPurchaseMessage()} className=" w-max px-10 py-1 font-blod rounded-lg justify-center text-[#70685a] text-[18px] bg-[#ebe6e0] hover:bg-blue-700 focus:outline-none">
                                        送信
                                    </button>
                                </div>
                            </div>
