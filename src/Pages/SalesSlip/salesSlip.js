            ...
            <Titlebar title={title} />
                        ...
                        <div className='flex ml-10' style={{width:'80%'}}>
                            <div className='flex justify-between  mt-5 w-full' >
                                <ButtonComponent children={'全て'} className="!px-5  bg-[transparent] border border-[#424242] !text-[#424242] h-8 rounded-lg !w-max overflow-hidden" />
                                <ButtonComponent children={'貴金属'}  className="!px-5 bg-[transparent] border border-[#424242] !text-[#424242] h-8 rounded-lg !w-max overflow-hidden"  />
                                <ButtonComponent children={'ブランド'} className="!px-5 bg-[transparent] border border-[#424242] !text-[#424242] h-8 rounded-lg !w-max overflow-hidden"  />
                                <ButtonComponent children={'バッグ'} className="!px-5 bg-[transparent] border border-[#424242] !text-[#424242] h-8 rounded-lg !w-max overflow-hidden"   />
                                <ButtonComponent children={'時計'} className="!px-5 bg-[transparent] border border-[#424242] !text-[#424242] h-8 rounded-lg !w-max overflow-hidden"  />
                                <ButtonComponent children={'財布'} className="!px-5 bg-[transparent] border border-[#424242] !text-[#424242] h-8 rounded-lg !w-max overflow-hidden"   />
                                <ButtonComponent children={'アクセサリ'} className="!px-5 bg-[transparent] border border-[#424242] !text-[#424242] h-8 rounded-lg !w-max overflow-hidden"  />
                                <ButtonComponent children={'骨董品'} className="!px-5 bg-[transparent] border border-[#424242] !text-[#424242] h-8 rounded-lg !w-max overflow-hidden"   />
                                <ButtonComponent children={'洋酒'}  className="!px-5 bg-[transparent] border border-[#424242] !text-[#424242] h-8 rounded-lg !w-max overflow-hidden" />
                                <ButtonComponent children={'カメラ'} className="!px-5 bg-[transparent] border border-[#424242] !text-[#424242] h-8 rounded-lg !w-max overflow-hidden"   />
                                <ButtonComponent children={'楽器'} className="!px-5 bg-[transparent] border border-[#424242] !text-[#424242] h-8 rounded-lg !w-max overflow-hidden"  />
