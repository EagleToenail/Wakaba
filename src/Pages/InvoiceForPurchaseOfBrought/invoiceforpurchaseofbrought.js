                            ...
                            <div className='w-full mt-10 '>
                                <div className='invoice-purchase-brought flex justify-between'>
                                    ...
                                    <div className='invoice-purchase-brought-buttons w-[50%] flex justify-around pr-10'>
                                        <ButtonComponent children="預り証発行" className='w-max h-11 !px-5' style={{ border: '1px solid #e87a00', backgroundColor: 'transparent', color: '#e87a00'}} />
            ...
            <div className="flex justify-center">
                <div className='w-full pt-3 pb-20' style={{ maxWidth: '80em' }}>
                    ...
                    <div className='invoice-purchase-brought flex justify-center pt-3'>
                        ...
                        <div className='flex justify-center'>
                            <select id="classificatin3" name="classificatin" className="w-40 h-11 text-[#70685a] font-bold border border-[#70685a] px-4 py-2 mr-5 outline-[#70685a]">
                                <option value="1">なし</option>
                                <option value="2">Afghanistan</option>
                                <option value="3">Åland Islands</option>
                                <option value="4">Albania</option>
                            </select>
                            <InputComponent className='mr-5 w-20 h-11'/>
                            <label className="text-[#70685a] font-bold mb-2 block text-left !mb-0 pt-2 " >To</label>
