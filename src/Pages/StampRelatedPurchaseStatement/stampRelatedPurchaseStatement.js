...
const StampRelatedPurchaseStatement = () => {
    ...
    const calculateSheet = (numberofsheets) => {
        ...
        if (sheetValue) {
            ...
            const caluclatePruchase =  Number(calculatedProduct) * (1 - Number(stampRate.sheetrate)/100);
                ...
                <div className="w-full ">
                    ...
                    <div className='flex justify-around mt-5'>
                        <div className='flex'>
                            ...
                            <InputComponent className='w-full h-10' disabled={true}/>
                        </div>
                        <div className='flex'>
                                ...
                                <div className='flex w-full'>
                                    ...
                                    <div className='flex justify-end w-1/2'>
                                        <div>
                                            ...
                                            <InputComponent type='number' style={{ width: '100px', height: '30px' }} />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className='flex w-full'>
                                    ...
                                    <div className='flex justify-end w-1/2'>
                                        <div>
                                            ...
                                            <InputComponent tylpe='number' style={{ width: '100px', height: '30px' }} />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div>
                                    <div>
                                        <table className=' text-center w-full' style={Table}>
                                            <thead className='!h-8 text-[14px]'>
                                                <tr>
                                                    <th style={Th} className='p1-1 pr-1 !w-20'>額面</th>
                                                    <th style={Th} >面数(￥)</th>
                                                ...
                                                {packRows?.length > 0 && packRows.map((row, Index) => (
                                                    <tr key={Index} className='!h-6'>
                                                        ...
                                                        <td style={Td} >
                                                            <div className='w-20'>
                                                                {editPackIndex === Index ? (
                                                                    <InputComponent disabled={true} name='faceValue' value={editedPackRow.faceValue || ''} onChange={handlePackInputChange} className='w-full h-8 text-[#70685a]' />
                                                                ) : (row.faceValue || '')}
                                                            </div>
                                                        </td>
                                                        <td style={Td}>
                                                            {editPackIndex === Index ? (
                                                                <InputComponent type='number' name='quantity' value={editedPackRow.quantity || ''} onChange={handlePackInputChange} className='w-full h-8 text-[#70685a] !border-[red]' />
                                                            ) : (row.quantity || '')}
                                                        </td>
                                                        <td style={Td}>
                                                            {editPackIndex === Index ? (
                                                    ...
                                                    <tbody>
                                                        {cardRows?.length > 0 && cardRows.map((row, Index) => (
                                                            <tr key={Index} >
                                                                <td style={Td}>
                                                                    {editCardIndex === Index ? (
                                                                        <InputComponent disabled={true} name='type' value={editedCardRow.type || ''} onChange={handleCardInputChange} className='w-full h-8 text-[#70685a]' />
                                                                    ) : (row.type || '')}
                                                                </td>
                                                                <td style={Td}>
                                                                    {editCardIndex === Index ? (
                                                                        <InputComponent type='number' name='quantity' value={editedCardRow.quantity || ''} onChange={handleCardInputChange} className='w-full h-8 text-[#70685a] !border-[red]' />
                                                                    ) : (row.quantity || '')}
                                                                </td>
                                                                <td style={Td}>
                                                                    {editCardIndex === Index ? (
