        ...
        <div className="bg-[trasparent] font-[sans-serif] w-full">
                        ...
                        <tbody>
                            {
                                ...
                                <tr className='!h-8'>
                                    ...
                                    {isDetailShow ? salesSlipData.product_type_one === '洋酒' ?
                                        <td style={Td}>
                                            <InputComponent list='wine-brands' name='brand' type='text' onChange={handleChange} value={salesSlipData.brand || ''} className='w-max min-w-40 h-8 text-[#70685a]' />
            ...
            <div className="flex justify-center">
                <div className='w-full pb-20' style={{ maxWidth: '80em' }}>
                    <div className='flex flex-col justify-center pt-3 w-full'>
                        <div className='invoice-purchase-brought flex justify-center pt-3 '>
                            <div className='invoice-purchase-brought-one flex justify-center w-[50%]'>
                                <input type='checkbox' name='google_review' checked={customer.line_friend === 'yes'} onChange={handleCustomerChange} className='mr-3' />
                    ...
                    <div className='invoice-purchase-brought flex justify-center pt-3'>
                        <div className='invoice-purchase-brought-one flex justify-center w-[50%]'>
                            <input type='checkbox' name='google_review' checked={customer.google_review === 'yes'} onChange={handleCustomerChange} className='mr-3' />
