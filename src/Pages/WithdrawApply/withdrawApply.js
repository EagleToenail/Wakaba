    ...
    const sendWithdrawalApplyMessage = async () => {
        ...
        if (reply.title != '' && reply.content != '' && reply.senderId != '' && reply.receiverId != '') {
            ...
            try {
                ...
                await axios.post(`${wakabaBaseUrl}/withdrawalapplymessages/getmessagelist`, formData, {
                    headers: {
                ...
                <div className="w-full">
                    <div className='w-full'>
                        ...
                        <div className='w-full h-[400px]'>
                            <WithdrawalApplyAccordion onSendIdData={handleDataFromChildAccordion} messages={messages}/>
                        </div>
                    </div>
                    {/* new post */}
                    ...
                    <div className='flex'>
                        ...
                        <div style={{ width: '90%', height: '50px' }} className='text-center'>
                            {/* firstline */}
                            <div className='withdrawal-apply flex justify-between'>
                                <div style={{ position: 'relative', width: '20%' }} className='mt-3' ref={dropdownRef}>
                                    <input
                                        type="text"
                                        placeholder=""
                                ...
                                <div className= 'mt-3'>
                                    <select id="gender" name="gender" className="w-full h-11 text-[#70685a] font-bold border border-[#70685a] px-4 py-2 outline-[#70685a]">
                            ...
                            <div className='flex mt-2' style={{ height: '55px' }}>
                                ...
                                <div className='ml-10 flex flex-col justify-center'>
                                    < button type="button" onClick={() => sendWithdrawalApplyMessage()} className=" w-max px-10 py-1 font-blod rounded-lg justify-center text-[#70685a] text-[18px] bg-[#ebe6e0] hover:bg-blue-700 focus:outline-none">
                                        送信
                                    </button>
                                </div>
                            </div>
